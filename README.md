...
* I wonder if there are more tricks like the swap-to-two-new-greens trick. Note that a swap to two new greens is a cycle of length 2. I wonder if, after checking for any 2-cycles, you can safely do any 3-cycles? If this doesn't work, a counter example would be nice.
